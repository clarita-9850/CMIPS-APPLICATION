...
export default function RecipientRegistrationPage() {
  ...
  const handleStart = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      if (!caseNumber || !cinLast4 || !lastName || !dob) {
        setError('Please fill in all fields.');
        return;
      }
      const resp = await apiClient.post<StartRegistrationResponse>('/esp/register/recipient/start', {
        caseNumber,
        cinLast4,
        lastName,
        dateOfBirth: dob,
        ...
        {step === 1 && (
          <form onSubmit={handleStart} className="space-y-4">
            ...
            <p className="text-xs text-gray-600">
              Enter your case information exactly as it appears in your IHSS
              paperwork.
            </p>
            <div>
            ...
            <div>
              ...
              <input
                ...
                maxLength={4}
                value={cinLast4}
                onChange={(e) => setCinLast4(e.target.value)}
                required
              />
            </div>
            <div>
        ...
        {step === 3 && (
          <form onSubmit={handleSetUsername} className="space-y-4">
            ...
            {usernameAvailable === true && (
              <p className="text-xs text-green-700">Username is available.</p>
            )}
        ...
        {step === 6 && (
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-gray-600">
              ...
              and approve timesheets, view providers, and manage your IHSS
              services.
            </p>
            <Link
              href="/login"
              className="inline-block mt-2 py-2.5 px-6 bg-[#1e3a8a] text-white rounded-md text-sm font-semibold hover:bg-[#1e40af]"
            >
              Go to Login
            </Link>
          </div>
