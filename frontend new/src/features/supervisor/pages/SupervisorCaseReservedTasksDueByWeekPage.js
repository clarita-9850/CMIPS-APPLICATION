...
export function SupervisorCaseReservedTasksDueByWeekPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_caseReservedTasksDueByWeek"}
...
export default SupervisorCaseReservedTasksDueByWeekPage;
