...
export function SupervisorOpenTasksReservedByWorkQueueUserPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_openTasksReservedByWorkQueueUser"}
...
export default SupervisorOpenTasksReservedByWorkQueueUserPage;
