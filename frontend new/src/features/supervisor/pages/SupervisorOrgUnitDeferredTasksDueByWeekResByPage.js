...
export function SupervisorOrgUnitDeferredTasksDueByWeekResByPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_orgUnitDeferredTasksDueByWeekResBy"}
...
export default SupervisorOrgUnitDeferredTasksDueByWeekResByPage;
