...
export function SupervisorDeferredTasksDueByWeekReservedByWorkQueueUserPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_deferredTasksDueByWeekReservedByWorkQueueUser"}
      title={"Reserved Work Queue Tasks By Week:"}
      navLinks={NAV_LINKS}
...
export default SupervisorDeferredTasksDueByWeekReservedByWorkQueueUserPage;
