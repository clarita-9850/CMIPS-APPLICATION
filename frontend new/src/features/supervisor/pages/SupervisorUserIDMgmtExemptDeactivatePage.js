...
export function SupervisorUserIDMgmtExemptDeactivatePage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_userIDMgmtExemptDeactivate"}
      title={"User I D Mgmt Exempt Deactivate"}
      navLinks={NAV_LINKS}
...
export default SupervisorUserIDMgmtExemptDeactivatePage;
