...
const NAV_LINKS = [
    { label: 'clear Task Redirection', route: '/supervisor/clear-task-redirection' }
  ];

export function SupervisorRedirectTasksToUsersPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_redirectTasksToUsers"}
      title={"Task Redirection"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Details"}>
        <div className="uim-form-grid">
          <UimField label={"Redirect To User"} value={record && record['redirectToUser']} />
      ...
      <div className="uim-action-bar">
        <button className="uim-btn uim-btn-primary" onClick={() => window.location.reload()}>Clear</button>
...
export default SupervisorRedirectTasksToUsersPage;
