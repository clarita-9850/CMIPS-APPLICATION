...
export function SupervisorCaseAssignedTasksDueOnDatePage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_caseAssignedTasksDueOnDate"}
...
export default SupervisorCaseAssignedTasksDueOnDatePage;
