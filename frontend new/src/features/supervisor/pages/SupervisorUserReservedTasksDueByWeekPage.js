...
export function SupervisorUserReservedTasksDueByWeekPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_userReservedTasksDueByWeek"}
...
export default SupervisorUserReservedTasksDueByWeekPage;
