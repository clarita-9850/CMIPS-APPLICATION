...
export function SupervisorCaseReservedTasksDueOnDatePage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_caseReservedTasksDueOnDate"}
...
export default SupervisorCaseReservedTasksDueOnDatePage;
