...
export function SupervisorDeferredTasksReservedByWorkQueueUserPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_deferredTasksReservedByWorkQueueUser"}
...
export default SupervisorDeferredTasksReservedByWorkQueueUserPage;
