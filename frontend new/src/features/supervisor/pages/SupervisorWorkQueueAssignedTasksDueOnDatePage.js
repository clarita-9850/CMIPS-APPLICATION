...
export function SupervisorWorkQueueAssignedTasksDueOnDatePage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_workQueueAssignedTasksDueOnDate"}
...
export default SupervisorWorkQueueAssignedTasksDueOnDatePage;
