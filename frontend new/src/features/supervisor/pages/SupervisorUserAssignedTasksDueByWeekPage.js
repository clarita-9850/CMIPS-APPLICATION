...
export function SupervisorUserAssignedTasksDueByWeekPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_userAssignedTasksDueByWeek"}
...
export default SupervisorUserAssignedTasksDueByWeekPage;
