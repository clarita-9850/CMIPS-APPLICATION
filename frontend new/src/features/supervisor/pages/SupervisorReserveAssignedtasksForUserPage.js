...
export function SupervisorReserveAssignedtasksForUserPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_reserveAssignedtasksForUser"}
      title={"Reserve Assigned Tasks"}
      navLinks={NAV_LINKS}
...
export default SupervisorReserveAssignedtasksForUserPage;
