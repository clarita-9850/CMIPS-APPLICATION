...
const NAV_LINKS = [
    { label: 'reserve Case Tasks', route: '/supervisor/reserve-case-tasks' },
...
export function SupervisorCaseAssignedTasksPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_caseAssignedTasks"}
      title={"Case Assigned Tasks"}
      navLinks={NAV_LINKS}
...
export default SupervisorCaseAssignedTasksPage;
