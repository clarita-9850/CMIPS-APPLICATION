...
export function SupervisorWorkQueueAssignedTasksDueByWeekPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_workQueueAssignedTasksDueByWeek"}
      title={"Work Queue Workspace"}
      navLinks={NAV_LINKS}
...
export default SupervisorWorkQueueAssignedTasksDueByWeekPage;
