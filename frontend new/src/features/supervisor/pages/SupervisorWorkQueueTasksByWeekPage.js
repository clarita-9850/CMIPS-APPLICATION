...
export function SupervisorWorkQueueTasksByWeekPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_workQueueTasksByWeek"}
      title={"Work Queue Tasks By Week:\\\\"}
      navLinks={NAV_LINKS}
...
export default SupervisorWorkQueueTasksByWeekPage;
