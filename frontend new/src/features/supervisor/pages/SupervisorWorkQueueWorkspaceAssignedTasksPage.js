...
const NAV_LINKS = [
    { label: 'reserve Work Queue Assigned Tasks To User', route: '/supervisor/reserve-work-queue-assigned-tasks-to-user' },
...
export function SupervisorWorkQueueWorkspaceAssignedTasksPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_workQueueWorkspaceAssignedTasks"}
    ...
    >
      ...
      <UimSection title={"Filter Criteria"}>
        <div className="uim-form-grid">
          ...
          <UimField label={"Deadline Start Date"} value={record && record['deadlineStartDate']} />
          <UimField label={"Creation Start Date"} value={record && record['creationStartDate']} />
          <UimField label={"Max Tasks Shown"} value={record && record['maxTasksShown']} />
          <UimField label={"Priority"} value={record && record['priority']} />
          <UimField label={"Deadline End Date"} value={record && record['deadlineEndDate']} />
          <UimField label={"Creation End Date"} value={record && record['creationEndDate']} />
      ...
      <div className="uim-action-bar">
        <button className="uim-btn uim-btn-primary" onClick={() => navigate('/supervisor/reserve-task')}>Reserve Tasks</button>
...
export default SupervisorWorkQueueWorkspaceAssignedTasksPage;
