...
export function SupervisorCaseAssignedTasksDueByWeekPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_caseAssignedTasksDueByWeek"}
...
export default SupervisorCaseAssignedTasksDueByWeekPage;
