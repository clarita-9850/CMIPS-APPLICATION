...
export function SupervisorDeferredTasksReservedByOrganizationUnitUserPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Supervisor_deferredTasksReservedByOrganizationUnitUser"}
...
export default SupervisorDeferredTasksReservedByOrganizationUnitUserPage;
