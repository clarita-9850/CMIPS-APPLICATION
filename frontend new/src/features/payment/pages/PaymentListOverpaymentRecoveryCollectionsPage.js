...
export function PaymentListOverpaymentRecoveryCollectionsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Payment_listOverpaymentRecoveryCollections"}
    ...
    >
      ...
      <div className="uim-action-bar">
        ...
        <button className="uim-btn uim-btn-primary" onClick={() => { timesheetsApi.search({}).then(results => alert('Found ' + (results?.length || 0) + ' results')).catch(err => alert('Search failed: ' + err.message)); }}>Search</button>
...
export default PaymentListOverpaymentRecoveryCollectionsPage;
