...
export function WorkAllocationAddWorkQueueSubscriptionPage() {
  ...
  return (
    <UimPageLayout
      pageId={"WorkAllocation_addWorkQueueSubscription"}
      title={"Add Work Queue Subscription:"}
      navLinks={NAV_LINKS}
...
export default WorkAllocationAddWorkQueueSubscriptionPage;
