...
export function WorkAllocationCreateWorkQueueSubscriptionPage() {
  const navigate = useNavigate();
  const tasksApi = getDomainApi('task-management');
  return (
    <UimPageLayout
      pageId={"WorkAllocation_createWorkQueueSubscription"}
...
export default WorkAllocationCreateWorkQueueSubscriptionPage;
