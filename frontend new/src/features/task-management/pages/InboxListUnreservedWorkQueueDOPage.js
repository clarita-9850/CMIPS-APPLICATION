...
export function InboxListUnreservedWorkQueueDOPage() {
  const { data, loading, error } = useDomainData('task-management', 'list');
  const record = Array.isArray(data) ? data[0] : data;
  return (
    <UimPageLayout
      pageId={"Inbox_listUnreservedWorkQueueDO"}
    ...
    >
      ...
      <UimSection title={"Search Result"}>
        <UimTable
...
export default InboxListUnreservedWorkQueueDOPage;
