...
export function TaskManagementDeferTaskPage() {
  ...
  return (
    <UimPageLayout
      pageId={"TaskManagement_DeferTask"}
      title={"Defer Task:"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Details"}>
        <div className="uim-form-grid">
          <UimField label={"Restart Date"} value={record && record['restartDate']} />
        </div>
      </UimSection>
...
export default TaskManagementDeferTaskPage;
