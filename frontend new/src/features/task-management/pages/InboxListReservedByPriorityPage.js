...
export function InboxListReservedByPriorityPage() {
  const { data, loading, error } = useDomainData('task-management', 'list');
  const record = Array.isArray(data) ? data[0] : data;
  return (
    <UimPageLayout
      pageId={"Inbox_listReservedByPriority"}
      title={"Reserved Tasks by Priority:\\\\"}
      navLinks={NAV_LINKS}
...
export default InboxListReservedByPriorityPage;
