...
const NAV_LINKS = [
    ...
    { label: 'modify Note From View', route: '/case/modify-note-from-view' },
    { label: 'cancel Note', route: '/case/cancel-note' },
    { label: 'list Notes', route: '/case/list-notes' }
  ];

export function CaseViewNotePage() {
  ...
  return (
    ...
    >
      ...
      <UimSection title={"Notes History"}>
        <div className="uim-form-grid">
...
export default CaseViewNotePage;
