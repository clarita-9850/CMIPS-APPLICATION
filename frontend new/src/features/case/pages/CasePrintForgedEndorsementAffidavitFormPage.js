...
export function CasePrintForgedEndorsementAffidavitFormPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_printForgedEndorsementAffidavitForm"}
      title={"Print Forged Endorsement Affidavit Form:\\\\"}
      navLinks={NAV_LINKS}
...
export default CasePrintForgedEndorsementAffidavitFormPage;
