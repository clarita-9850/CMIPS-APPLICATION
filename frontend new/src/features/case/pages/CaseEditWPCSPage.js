...
export function CaseEditWPCSPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_editWPCS"}
      title={"Modify WPCS Hours:"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Details"}>
        <div className="uim-form-grid">
          <UimField label={"WPCS Hours (HH:MM)"} value={record && record['wPCSHoursHHMM']} />
...
export default CaseEditWPCSPage;
