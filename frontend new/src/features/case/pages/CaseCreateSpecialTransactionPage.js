...
export function CaseCreateSpecialTransactionPage() {
  const navigate = useNavigate();
  const casesApi = getDomainApi('case');
  return (
    <UimPageLayout
      pageId={"Case_createSpecialTransaction"}
      title={"Create Special Transaction:"}
      navLinks={NAV_LINKS}
...
export default CaseCreateSpecialTransactionPage;
