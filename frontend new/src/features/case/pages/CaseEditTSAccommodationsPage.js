...
const NAV_LINKS = [
    { label: 'resolve Edit T T S Accommodations', route: '/case/resolve-edit-tts-accommodations' },
    { label: 'timesheet Preferences', route: '/case/timesheet-preferences' }
  ];

export function CaseEditTSAccommodationsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_editTSAccommodations"}
      title={"Modify Recipient Timesheet Accommodations:"}
      navLinks={NAV_LINKS}
...
export default CaseEditTSAccommodationsPage;
