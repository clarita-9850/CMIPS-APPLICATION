...
export function CaseModifyIHSSDifferentialPRHoursPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyIHSSDifferentialPRHours"}
      title={"Modify IHSS Differential Pay Rate Hours:"}
      navLinks={NAV_LINKS}
...
export default CaseModifyIHSSDifferentialPRHoursPage;
