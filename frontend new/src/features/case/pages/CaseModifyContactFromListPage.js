...
export function CaseModifyContactFromListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyContactFromList"}
      title={"Modify Contact From List"}
      navLinks={NAV_LINKS}
...
export default CaseModifyContactFromListPage;
