...
export function CaseResetRegistrationCodePage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_resetRegistrationCode"}
      title={"Reset Recipient TTS Registration Code:"}
      navLinks={NAV_LINKS}
...
export default CaseResetRegistrationCodePage;
