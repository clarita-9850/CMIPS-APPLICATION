...
export function CaseEditForgedEndorsementAffidavitPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_editForgedEndorsementAffidavit"}
      title={"Modify Forged Endorsement Affidavit:"}
      navLinks={NAV_LINKS}
...
export default CaseEditForgedEndorsementAffidavitPage;
