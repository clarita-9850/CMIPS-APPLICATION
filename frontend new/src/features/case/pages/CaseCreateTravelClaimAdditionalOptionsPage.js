...
export function CaseCreateTravelClaimAdditionalOptionsPage() {
  const navigate = useNavigate();
  const casesApi = getDomainApi('case');
  return (
    <UimPageLayout
      pageId={"Case_createTravelClaimAdditionalOptions"}
...
export default CaseCreateTravelClaimAdditionalOptionsPage;
