...
export function CaseEditExcessCompensationRateDetailsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_editExcessCompensationRateDetails"}
      title={"Modify Excess Compensation  Rate Details:"}
      navLinks={NAV_LINKS}
...
export default CaseEditExcessCompensationRateDetailsPage;
