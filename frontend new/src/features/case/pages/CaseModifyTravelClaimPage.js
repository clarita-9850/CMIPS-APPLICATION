...
export function CaseModifyTravelClaimPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyTravelClaim"}
      title={"Modify Travel Claim Manual Entry:\\\\"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Time Entries [HH:MM]"}>
        <div className="uim-form-grid">
          ...
          <UimField label={"Remaining Hrs (HH:MM)"} value={record && record['remainingHrsHHMM']} />
...
export default CaseModifyTravelClaimPage;
