...
export function CaseLeaveTerminateProviderPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_leaveTerminateProvider"}
      title={"Leave/Terminate Case Provider:"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Details"}>
        <div className="uim-form-grid">
          ...
          <UimField label={"End Date Workweek Agreement"} value={record && record['endDateWorkweekAgreement']} />
...
export default CaseLeaveTerminateProviderPage;
