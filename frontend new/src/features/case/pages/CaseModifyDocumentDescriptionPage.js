...
export function CaseModifyDocumentDescriptionPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyDocumentDescription"}
      title={"Modify Attachment Description:"}
      navLinks={NAV_LINKS}
...
export default CaseModifyDocumentDescriptionPage;
