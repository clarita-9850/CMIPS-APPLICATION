...
export function CaseModifyProviderForViewPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyProviderForView"}
      title={"Modify Provider For View"}
      navLinks={NAV_LINKS}
...
export default CaseModifyProviderForViewPage;
