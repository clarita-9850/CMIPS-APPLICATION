...
export function CaseCreateProviderWPCSHoursPage() {
  const navigate = useNavigate();
  const casesApi = getDomainApi('case');
  return (
    <UimPageLayout
      pageId={"Case_createProviderWPCSHours"}
      title={"Create WPCS Details:"}
      navLinks={NAV_LINKS}
...
export default CaseCreateProviderWPCSHoursPage;
