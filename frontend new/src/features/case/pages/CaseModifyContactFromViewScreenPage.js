...
export function CaseModifyContactFromViewScreenPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyContactFromViewScreen"}
      title={"Modify Contact From View Screen"}
      navLinks={NAV_LINKS}
...
export default CaseModifyContactFromViewScreenPage;
