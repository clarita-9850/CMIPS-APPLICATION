...
export function CaseSubmitAdvancePayReconActionPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_submitAdvancePayReconAction"}
      title={"Advance Pay Recon Actions:"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Service Month"}>
        <div className="uim-form-grid">
          ...
          <UimField label={"Reconciliation Action"} value={record && record['reconciliationAction']} />
        </div>
      </UimSection>
...
export default CaseSubmitAdvancePayReconActionPage;
