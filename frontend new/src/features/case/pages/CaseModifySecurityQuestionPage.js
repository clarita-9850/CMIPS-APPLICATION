...
export function CaseModifySecurityQuestionPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifySecurityQuestion"}
      title={"PageTitle"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Security Questions"}>
...
export default CaseModifySecurityQuestionPage;
