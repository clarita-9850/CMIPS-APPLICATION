...
export function CaseModifyTelehealthQuestionnaireDetailsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyTelehealthQuestionnaireDetails"}
      title={"Telehealth Questionnaire Details:"}
      navLinks={NAV_LINKS}
...
export default CaseModifyTelehealthQuestionnaireDetailsPage;
