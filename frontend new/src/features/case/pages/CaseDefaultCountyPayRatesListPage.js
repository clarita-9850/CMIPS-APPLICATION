...
export function CaseDefaultCountyPayRatesListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_defaultCountyPayRatesList"}
      title={"Default County Pay Rates List"}
      navLinks={NAV_LINKS}
...
export default CaseDefaultCountyPayRatesListPage;
