...
export function CaseEnterExceptionPaymentCorrectionPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_enterExceptionPaymentCorrection"}
...
export default CaseEnterExceptionPaymentCorrectionPage;
