...
export function CaseModifyWPCSDifferentialPRHoursPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyWPCSDifferentialPRHours"}
      title={"Modify WPCS Differential Pay Rate Hours:"}
      navLinks={NAV_LINKS}
      hidePlaceholderBanner={true}
    >
      {loading && <div className="uim-info-banner">Loading data...</div>}
      {error && <div className="uim-info-banner" style={{background:'#f8d7da',borderColor:'#f5c6cb',color:'#721c24'}}>Unable to load data. The backend may be unavailable.</div>}
      <UimSection title={"Differential Pay Rate Hours"}>
...
export default CaseModifyWPCSDifferentialPRHoursPage;
