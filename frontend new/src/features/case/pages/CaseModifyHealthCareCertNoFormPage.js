...
export function CaseModifyHealthCareCertNoFormPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyHealthCareCertNoForm"}
    ...
    >
      ...
      <UimSection title={"Modify Health Care Certification-No Form Printed"}>
...
export default CaseModifyHealthCareCertNoFormPage;
