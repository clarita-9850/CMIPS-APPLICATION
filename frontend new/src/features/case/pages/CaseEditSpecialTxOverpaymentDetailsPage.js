...
export function CaseEditSpecialTxOverpaymentDetailsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_editSpecialTxOverpaymentDetails"}
...
export default CaseEditSpecialTxOverpaymentDetailsPage;
