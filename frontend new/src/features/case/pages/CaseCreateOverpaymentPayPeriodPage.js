...
const NAV_LINKS = [
    { label: 'view Overpayment Pay Period', route: '/payment/view-overpayment-pay-period' },
    { label: 'resolve Overpayment Pay Period', route: '/case/resolve-overpayment-pay-period' }
  ];

export function CaseCreateOverpaymentPayPeriodPage() {
  const navigate = useNavigate();
  const casesApi = getDomainApi('case');
  return (
    <UimPageLayout
      pageId={"Case_createOverpaymentPayPeriod"}
...
export default CaseCreateOverpaymentPayPeriodPage;
