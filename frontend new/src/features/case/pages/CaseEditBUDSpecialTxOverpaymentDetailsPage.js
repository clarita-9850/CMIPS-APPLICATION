...
export function CaseEditBUDSpecialTxOverpaymentDetailsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_editBUDSpecialTxOverpaymentDetails"}
      title={"Modify Special Transaction Overpayment Details:"}
      navLinks={NAV_LINKS}
...
export default CaseEditBUDSpecialTxOverpaymentDetailsPage;
