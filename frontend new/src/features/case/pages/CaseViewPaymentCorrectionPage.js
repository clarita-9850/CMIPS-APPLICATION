...
const NAV_LINKS = [
    ...
    { label: 'list Payment Corrections', route: '/case/list-payment-corrections' },
...
export function CaseViewPaymentCorrectionPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_viewPaymentCorrection"}
...
export default CaseViewPaymentCorrectionPage;
