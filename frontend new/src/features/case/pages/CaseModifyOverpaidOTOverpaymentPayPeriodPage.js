...
const NAV_LINKS = [
    { label: 'resolve Modify Overpaid O T Daily Entries', route: '/case/resolve-modify-overpaid-ot-daily-entries' }
  ];

export function CaseModifyOverpaidOTOverpaymentPayPeriodPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyOverpaidOTOverpaymentPayPeriod"}
    ...
    >
      ...
      <UimSection title={"Details"}>
        <div className="uim-form-grid">
          <UimField label={"Select Warrant - Service Period"} value={record && record['selectWarrantServicePeriod']} />
...
export default CaseModifyOverpaidOTOverpaymentPayPeriodPage;
