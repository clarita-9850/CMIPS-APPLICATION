...
export function CaseOrganizationOrganizationUnitSearchPopupPage() {
  ...
  return (
    <UimPageLayout
      pageId={"CaseOrganization_organizationUnitSearchPopup"}
...
export default CaseOrganizationOrganizationUnitSearchPopupPage;
