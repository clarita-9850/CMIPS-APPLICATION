...
export function CaseModifyProviderForListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyProviderForList"}
      title={"Modify Provider For List"}
      navLinks={NAV_LINKS}
...
export default CaseModifyProviderForListPage;
