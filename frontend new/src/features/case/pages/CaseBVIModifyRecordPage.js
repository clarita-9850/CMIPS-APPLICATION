...
export function CaseBVIModifyRecordPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_BVIModifyRecord"}
      title={"Modify Blind or Visually Impaired:\\\\"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Modify Blind or Visually Impaired"}>
        <div className="uim-form-grid">
...
export default CaseBVIModifyRecordPage;
