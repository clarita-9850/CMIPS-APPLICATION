...
const NAV_LINKS = [
    { label: 'resolve Create Travel Claim', route: '/case/resolve-create-travel-claim' },
    { label: 'resolve Create Travel Claim New', route: '/case/resolve-create-travel-claim-new' },
    { label: 'enter Travel Claim Num', route: '/case/enter-travel-claim-num' }
  ];

export function CaseCreateTravelClaimPage() {
  const navigate = useNavigate();
  const casesApi = getDomainApi('case');
  return (
    <UimPageLayout
      pageId={"Case_createTravelClaim"}
      title={"Travel Claim Manual Entry - Time Entries:\\\\"}
      navLinks={NAV_LINKS}
...
export default CaseCreateTravelClaimPage;
