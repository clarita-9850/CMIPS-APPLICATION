...
const NAV_LINKS = [
    ...
    { label: 'print Approved Form', route: '/case/print-approved-form' },
    { label: 'list Electronic Forms History', route: '/case/list-electronic-forms-history' },
    { label: 'print History Approved Form', route: '/case/print-history-approved-form' }
  ];

export function CaseListApprovedElectronicFormsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_listApprovedElectronicForms"}
    ...
    >
      ...
      <div className="uim-action-bar">
        ...
        <button className="uim-btn uim-btn-primary" onClick={() => navigate('/case/print-history-approved-form')}>Print History</button>
        <button className="uim-btn uim-btn-primary" onClick={() => alert('Action: View')}>View</button>
        <button className="uim-btn uim-btn-primary" onClick={() => window.print()}>Print</button>
        <button className="uim-btn uim-btn-primary" onClick={() => navigate('/case/list-electronic-forms-history')}>History</button>
        <button className="uim-btn uim-btn-primary" onClick={() => navigate('/case/print-history-approved-form')}>Print History</button>
...
export default CaseListApprovedElectronicFormsPage;
