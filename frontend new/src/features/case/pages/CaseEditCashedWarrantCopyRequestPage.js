...
export function CaseEditCashedWarrantCopyRequestPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_editCashedWarrantCopyRequest"}
      title={"Modify Cashed Warrant Copy Request:"}
      navLinks={NAV_LINKS}
...
export default CaseEditCashedWarrantCopyRequestPage;
