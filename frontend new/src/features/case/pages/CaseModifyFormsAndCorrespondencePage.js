...
export function CaseModifyFormsAndCorrespondencePage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyFormsAndCorrespondence"}
    ...
    >
      ...
      <UimSection title={"Reprint in Another Language"}>
        <div className="uim-form-grid">
          <UimField label={"Regenerate"} value={record && record['regenerate']} />
          <UimField label={"Status Date"} value={record && record['statusDate']} />
          <UimField label={"Language"} value={record && record['language']} />
...
export default CaseModifyFormsAndCorrespondencePage;
