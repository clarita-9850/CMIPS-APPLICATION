...
export function CaseEditAdvancePayOverpaymentDetailsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_editAdvancePayOverpaymentDetails"}
      title={"Modify Advance Payment Overpayment Details:"}
      navLinks={NAV_LINKS}
...
export default CaseEditAdvancePayOverpaymentDetailsPage;
