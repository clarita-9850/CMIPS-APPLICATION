...
export function CaseModifyUHVPhoneFollowupPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyUHVPhoneFollowup"}
      title={"Modify Phone Call Entry:"}
      navLinks={NAV_LINKS}
...
export default CaseModifyUHVPhoneFollowupPage;
