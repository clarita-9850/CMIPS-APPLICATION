...
const NAV_LINKS = [
    { label: 'change User', route: '/organization/change-user' }
  ];

export function CaseChangeCaseOwnerSearchPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_changeCaseOwnerSearch"}
      title={"User Search"}
      navLinks={NAV_LINKS}
...
export default CaseChangeCaseOwnerSearchPage;
