...
const NAV_LINKS = [
    { label: 'list County Pay Rates', route: '/case/list-county-pay-rates' }
  ];

export function CaseEditAdvancePayOverpaymentPayRatePage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_editAdvancePayOverpaymentPayRate"}
      title={"Edit Advance Pay Overpayment Pay Rate"}
      navLinks={NAV_LINKS}
...
export default CaseEditAdvancePayOverpaymentPayRatePage;
