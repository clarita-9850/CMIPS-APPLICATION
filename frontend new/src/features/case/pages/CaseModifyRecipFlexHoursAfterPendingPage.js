...
export function CaseModifyRecipFlexHoursAfterPendingPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Case_modifyRecipFlexHoursAfterPending"}
...
export default CaseModifyRecipFlexHoursAfterPendingPage;
