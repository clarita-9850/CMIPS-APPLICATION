...
const NAV_LINKS = [
    { label: 'reject Sick Leave Claim', route: '/person/reject-sick-leave-claim' },
    { label: 'view Work Queue List', route: '/task-management/view-work-queue-list' }
  ];

export function SickLeaveClaimReviewPage() {
  ...
  return (
    <UimPageLayout
      pageId={"SickLeaveClaim_Review"}
      title={"Review Sick Leave Claim"}
      navLinks={NAV_LINKS}
...
export default SickLeaveClaimReviewPage;
