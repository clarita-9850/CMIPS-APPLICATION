...
export function OrganizationCloseUserPage() {
  ...
  return (
    ...
    >
      ...
      <UimSection title={"Closure Details"}>
        <div className="uim-form-grid">
          <UimField label={"End Date"} value={record && record['endDate']} />
          <UimField label={"User's Supervisor"} value={record && record['userSSupervisor']} />
        </div>
      </UimSection>
      <UimSection title={"Task Redirection Details"}>
        <div className="uim-form-grid">
          <UimField label={"Lead User"} value={record && record['leadUser']} />
          <UimField label={"Reassign Task To"} value={record && record['reassignTaskTo']} />
        </div>
      </UimSection>
...
export default OrganizationCloseUserPage;
