...
export function OrganizationOrganizationUnitSearchPopupPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_organizationUnitSearchPopup"}
      title={"Organization Unit Search"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Search Criteria"}>
        <div className="uim-form-grid">
          <UimField label={"Organization Unit Name"} value={record && record['organizationUnitName']} />
          <UimField label={"Organization Unit Name"} value={record && record['organizationUnitName']} />
          <UimField label={"Business Type"} value={record && record['businessType']} />
...
export default OrganizationOrganizationUnitSearchPopupPage;
