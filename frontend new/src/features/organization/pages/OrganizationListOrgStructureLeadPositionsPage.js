...
const NAV_LINKS = [
    ...
    { label: 'modify Position From Org Struct Lead Pos List', route: '/organization/modify-position-from-org-struct-lead-pos-list' },
...
export function OrganizationListOrgStructureLeadPositionsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_listOrgStructureLeadPositions"}
...
export default OrganizationListOrgStructureLeadPositionsPage;
