...
const NAV_LINKS = [
    { label: 'create Job', route: '/organization/create-job' },
    { label: 'view Job', route: '/organization/view-job' },
    { label: 'modify Job From List', route: '/organization/modify-job-from-list' },
    { label: 'cancel Job', route: '/organization/cancel-job' },
    { label: 'view Job From Org Unit', route: '/organization/view-job-from-org-unit' }
  ];

export function OrganizationListOrganizationJobsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_listOrganizationJobs"}
    ...
    >
      ...
      <div className="uim-action-bar">
        ...
        <button className="uim-btn uim-btn-primary" onClick={() => navigate('/organization/view-job')}>View</button>
...
export default OrganizationListOrganizationJobsPage;
