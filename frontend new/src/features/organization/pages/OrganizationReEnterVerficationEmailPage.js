...
export function OrganizationReEnterVerficationEmailPage() {
  const { id } = useParams();
  ...
  return (
    <UimPageLayout
      pageId={"Organization_reEnterVerficationEmail"}
      title={"Re Enter Verfication Email"}
      navLinks={NAV_LINKS}
...
export default OrganizationReEnterVerficationEmailPage;
