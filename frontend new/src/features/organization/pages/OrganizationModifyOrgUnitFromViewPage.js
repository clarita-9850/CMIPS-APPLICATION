...
const NAV_LINKS = [
    { label: 'resolve Org Unit Home', route: '/organization/resolve-org-unit-home' },
    { label: 'org Unit Home', route: '/organization/org-unit-home' }
  ];

export function OrganizationModifyOrgUnitFromViewPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_modifyOrgUnitFromView"}
      title={"Modify Org Unit From View"}
      navLinks={NAV_LINKS}
...
export default OrganizationModifyOrgUnitFromViewPage;
