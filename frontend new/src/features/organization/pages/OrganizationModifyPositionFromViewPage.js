...
export function OrganizationModifyPositionFromViewPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_modifyPositionFromView"}
      title={"Modify Position From View"}
      navLinks={NAV_LINKS}
...
export default OrganizationModifyPositionFromViewPage;
