...
const NAV_LINKS = [
    { label: 'modify Job From View', route: '/organization/modify-job-from-view' },
    { label: 'cancel Job', route: '/organization/cancel-job' }
  ];

export function OrganizationViewJobPage() {
...
export default OrganizationViewJobPage;
