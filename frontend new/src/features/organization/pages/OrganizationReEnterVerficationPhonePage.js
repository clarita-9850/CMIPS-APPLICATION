...
export function OrganizationReEnterVerficationPhonePage() {
  const { id } = useParams();
  ...
  return (
    <UimPageLayout
      pageId={"Organization_reEnterVerficationPhone"}
      title={"Re Enter Verfication Phone"}
      navLinks={NAV_LINKS}
...
export default OrganizationReEnterVerficationPhonePage;
