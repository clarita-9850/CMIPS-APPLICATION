...
export function OrganizationEditAutoApprovePage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_editAutoApprove"}
      title={"Default Auto-Acceptance for Submitted Electronic Forms"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Details"}>
        <div className="uim-form-grid">
          <UimField label={"Yes"} value={record && record['yes']} />
          <UimField label={"No"} value={record && record['no']} />
        </div>
      </UimSection>
...
export default OrganizationEditAutoApprovePage;
