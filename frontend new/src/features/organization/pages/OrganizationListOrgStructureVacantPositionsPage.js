...
const NAV_LINKS = [
    { label: 'modify Position From Org Struct Vacant Pos List', route: '/organization/modify-position-from-org-struct-vacant-pos-list' },
...
export function OrganizationListOrgStructureVacantPositionsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_listOrgStructureVacantPositions"}
      title={"Vacant"}
      navLinks={NAV_LINKS}
...
export default OrganizationListOrgStructureVacantPositionsPage;
