...
export function OrganizationModifyOrgStructureFromListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_modifyOrgStructureFromList"}
      title={"Modify Org Structure From List"}
      navLinks={NAV_LINKS}
...
export default OrganizationModifyOrgStructureFromListPage;
