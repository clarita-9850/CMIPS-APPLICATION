...
export function OrganizationModifyOrgStructureFromViewPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_modifyOrgStructureFromView"}
      title={"Modify Org Structure From View"}
      navLinks={NAV_LINKS}
...
export default OrganizationModifyOrgStructureFromViewPage;
