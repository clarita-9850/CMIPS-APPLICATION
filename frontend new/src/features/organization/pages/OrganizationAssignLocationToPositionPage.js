...
export function OrganizationAssignLocationToPositionPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_AssignLocationToPosition"}
...
export default OrganizationAssignLocationToPositionPage;
