...
export function OrganizationCreateResourcePage() {
  const navigate = useNavigate();
  const organizationApi = getDomainApi('organization');
  return (
    <UimPageLayout
      pageId={"Organization_createResource"}
...
export default OrganizationCreateResourcePage;
