...
export function OrganizationActiveUserSearchDetailsPopupPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_activeUserSearchDetailsPopup"}
      title={"User Search"}
      navLinks={NAV_LINKS}
...
export default OrganizationActiveUserSearchDetailsPopupPage;
