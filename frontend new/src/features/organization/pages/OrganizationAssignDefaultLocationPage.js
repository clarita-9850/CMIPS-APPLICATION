...
export function OrganizationAssignDefaultLocationPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_AssignDefaultLocation"}
      title={"Assign Default Location:"}
      navLinks={NAV_LINKS}
...
export default OrganizationAssignDefaultLocationPage;
