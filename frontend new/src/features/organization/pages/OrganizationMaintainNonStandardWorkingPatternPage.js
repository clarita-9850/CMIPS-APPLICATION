...
export function OrganizationMaintainNonStandardWorkingPatternPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_maintainNonStandardWorkingPattern"}
...
export default OrganizationMaintainNonStandardWorkingPatternPage;
