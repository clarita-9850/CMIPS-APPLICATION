...
const NAV_LINKS = [
    ...
    { label: 'modify User From Org Structure List', route: '/organization/modify-user-from-org-structure-list' },
...
export function OrganizationListOrgStructureUsersPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Organization_listOrgStructureUsers"}
      title={"Users:"}
      navLinks={NAV_LINKS}
...
export default OrganizationListOrgStructureUsersPage;
