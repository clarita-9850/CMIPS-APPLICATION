...
import { createRate } from '../../../api/countyContractorApi';
...
/**
 * Validate rate form per DSD error messages.
  ...
  return (
    ...
    >
      ...
      <div className="uim-action-bar">
        <button className="uim-btn uim-btn-primary" onClick={() => handleSave(false)} disabled={saving}>
          {saving ? 'Saving...' : 'Save'}
        </button>
        <button className="uim-btn uim-btn-primary" onClick={() => handleSave(true)} disabled={saving}>
          Save &amp; New
        </button>
        <button className="uim-btn uim-btn-secondary" onClick={() => navigate('/county/list-county-contractor-rate')}>
          Cancel
        </button>
      </div>
    </UimPageLayout>
