...
export function EvidenceCreateListTaskWithoutProrationForSvcTypeFromViewPage() {
  const navigate = useNavigate();
  const eligibilityApi = getDomainApi('evidence');
  return (
    <UimPageLayout
      pageId={"Evidence_createListTaskWithoutProrationForSvcTypeFromView"}
...
export default EvidenceCreateListTaskWithoutProrationForSvcTypeFromViewPage;
