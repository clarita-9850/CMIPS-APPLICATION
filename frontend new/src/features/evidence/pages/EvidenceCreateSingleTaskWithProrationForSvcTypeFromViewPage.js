...
export function EvidenceCreateSingleTaskWithProrationForSvcTypeFromViewPage() {
  const navigate = useNavigate();
  const eligibilityApi = getDomainApi('evidence');
  return (
    <UimPageLayout
      pageId={"Evidence_createSingleTaskWithProrationForSvcTypeFromView"}
...
export default EvidenceCreateSingleTaskWithProrationForSvcTypeFromViewPage;
