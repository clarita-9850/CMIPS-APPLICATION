...
const NAV_LINKS = [
    { label: 'view Paramedical Service', route: '/evidence/view-paramedical-service' },
    { label: 'resolve Next Service Type Evidence I D', route: '/evidence/resolve-next-service-type-evidence-id' }
  ];

export function EvidenceModifyParamedicalServiceFromViewPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Evidence_modifyParamedicalServiceFromView"}
      title={"Modify Paramedical Service From View"}
      navLinks={NAV_LINKS}
...
export default EvidenceModifyParamedicalServiceFromViewPage;
