...
export function EvidenceCreateSingleTaskWithProrationForSvcTypeFromListPage() {
  const navigate = useNavigate();
  const eligibilityApi = getDomainApi('evidence');
  return (
    <UimPageLayout
      pageId={"Evidence_createSingleTaskWithProrationForSvcTypeFromList"}
...
export default EvidenceCreateSingleTaskWithProrationForSvcTypeFromListPage;
