...
export function EvidenceCreateListTaskWithProrationForSvcTypeFromListPage() {
  const navigate = useNavigate();
  const eligibilityApi = getDomainApi('evidence');
  return (
    <UimPageLayout
      pageId={"Evidence_createListTaskWithProrationForSvcTypeFromList"}
...
export default EvidenceCreateListTaskWithProrationForSvcTypeFromListPage;
