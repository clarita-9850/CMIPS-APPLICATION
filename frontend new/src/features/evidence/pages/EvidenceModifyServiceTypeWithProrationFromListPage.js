...
const NAV_LINKS = [
    ...
    { label: 'create Single Task With Proration For Svc Type From List', route: '/evidence/create-single-task-with-proration-for-svc-type-from-list' },
    { label: 'create Freeform Task With Proration For Svc Type From List', route: '/evidence/create-freeform-task-with-proration-for-svc-type-from-list' },
    { label: 'create List Task With Proration For Svc Type From List', route: '/evidence/create-list-task-with-proration-for-svc-type-from-list' },
    { label: 'modify Task With Proration For Svc Type From List', route: '/evidence/modify-task-with-proration-for-svc-type-from-list' },
    { label: 'delete Task With Proration For Svc Type From List', route: '/evidence/delete-task-with-proration-for-svc-type-from-list' }
  ];

export function EvidenceModifyServiceTypeWithProrationFromListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Evidence_modifyServiceTypeWithProrationFromList"}
...
export default EvidenceModifyServiceTypeWithProrationFromListPage;
