...
export function EvidenceModifyHouseholdMemberFromListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Evidence_modifyHouseholdMemberFromList"}
      title={"Modify Household Member From List"}
      navLinks={NAV_LINKS}
...
export default EvidenceModifyHouseholdMemberFromListPage;
