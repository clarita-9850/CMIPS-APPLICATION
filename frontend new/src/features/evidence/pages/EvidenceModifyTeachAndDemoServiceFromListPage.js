...
export function EvidenceModifyTeachAndDemoServiceFromListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Evidence_modifyTeachAndDemoServiceFromList"}
...
export default EvidenceModifyTeachAndDemoServiceFromListPage;
