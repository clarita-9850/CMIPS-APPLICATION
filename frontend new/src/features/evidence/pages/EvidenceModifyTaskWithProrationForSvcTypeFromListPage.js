...
export function EvidenceModifyTaskWithProrationForSvcTypeFromListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Evidence_modifyTaskWithProrationForSvcTypeFromList"}
      title={"Modify Task With Proration For Svc Type From List"}
      navLinks={NAV_LINKS}
...
export default EvidenceModifyTaskWithProrationForSvcTypeFromListPage;
