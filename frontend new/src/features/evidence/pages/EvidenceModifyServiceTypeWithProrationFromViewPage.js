...
const NAV_LINKS = [
    { label: 'view Service Type With Proration', route: '/evidence/view-service-type-with-proration' },
...
export function EvidenceModifyServiceTypeWithProrationFromViewPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Evidence_modifyServiceTypeWithProrationFromView"}
...
export default EvidenceModifyServiceTypeWithProrationFromViewPage;
