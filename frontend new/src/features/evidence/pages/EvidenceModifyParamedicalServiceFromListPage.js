...
export function EvidenceModifyParamedicalServiceFromListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Evidence_modifyParamedicalServiceFromList"}
      title={"Modify Paramedical Service From List"}
      navLinks={NAV_LINKS}
...
export default EvidenceModifyParamedicalServiceFromListPage;
