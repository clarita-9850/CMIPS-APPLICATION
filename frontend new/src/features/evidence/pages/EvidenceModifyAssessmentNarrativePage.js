...
export function EvidenceModifyAssessmentNarrativePage() {
  ...
  return (
    <UimPageLayout
      pageId={"Evidence_modifyAssessmentNarrative"}
      title={"Modify Assessment Narrative:"}
      navLinks={NAV_LINKS}
...
export default EvidenceModifyAssessmentNarrativePage;
