...
export function EvidenceModifyHouseholdMemberFromViewPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Evidence_modifyHouseholdMemberFromView"}
      title={"Modify Household Member From View"}
      navLinks={NAV_LINKS}
...
export default EvidenceModifyHouseholdMemberFromViewPage;
