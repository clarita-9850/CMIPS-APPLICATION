...
export function EvidenceModifyProtectiveSupervisionFromListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Evidence_modifyProtectiveSupervisionFromList"}
      title={"Modify Protective Supervision From List"}
      navLinks={NAV_LINKS}
...
export default EvidenceModifyProtectiveSupervisionFromListPage;
