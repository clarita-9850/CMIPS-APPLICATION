...
export function EvidenceCreateListTaskWithoutProrationForSvcTypeFromListPage() {
  const navigate = useNavigate();
  const eligibilityApi = getDomainApi('evidence');
  return (
    <UimPageLayout
      pageId={"Evidence_createListTaskWithoutProrationForSvcTypeFromList"}
...
export default EvidenceCreateListTaskWithoutProrationForSvcTypeFromListPage;
