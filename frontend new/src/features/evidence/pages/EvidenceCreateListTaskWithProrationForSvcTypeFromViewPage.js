...
export function EvidenceCreateListTaskWithProrationForSvcTypeFromViewPage() {
  const navigate = useNavigate();
  const eligibilityApi = getDomainApi('evidence');
  return (
    <UimPageLayout
      pageId={"Evidence_createListTaskWithProrationForSvcTypeFromView"}
...
export default EvidenceCreateListTaskWithProrationForSvcTypeFromViewPage;
