...
export function EvidenceCreateFreeformTaskWithProrationForSvcTypeFromListPage() {
  const navigate = useNavigate();
  const eligibilityApi = getDomainApi('evidence');
  return (
    <UimPageLayout
      pageId={"Evidence_createFreeformTaskWithProrationForSvcTypeFromList"}
...
export default EvidenceCreateFreeformTaskWithProrationForSvcTypeFromListPage;
