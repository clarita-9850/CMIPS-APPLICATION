...
export function PersonModifyStateAdminReviewAfterPendingPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_modifyStateAdminReviewAfterPending"}
      title={"Modify State Review:"}
      navLinks={NAV_LINKS}
...
export default PersonModifyStateAdminReviewAfterPendingPage;
