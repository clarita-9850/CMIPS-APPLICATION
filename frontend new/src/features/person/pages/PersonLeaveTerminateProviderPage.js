...
export function PersonLeaveTerminateProviderPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_leaveTerminateProvider"}
      title={"Leave/Terminate Provider Travel Time:"}
      navLinks={NAV_LINKS}
...
export default PersonLeaveTerminateProviderPage;
