...
export function PersonEditIncentiveCommentsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_editIncentiveComments"}
      title={"Incentive Claim Comments:"}
      navLinks={NAV_LINKS}
...
export default PersonEditIncentiveCommentsPage;
