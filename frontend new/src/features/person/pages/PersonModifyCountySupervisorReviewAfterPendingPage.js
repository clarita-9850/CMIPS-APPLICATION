...
export function PersonModifyCountySupervisorReviewAfterPendingPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_modifyCountySupervisorReviewAfterPending"}
      title={"Modify County Supervisor Review:"}
      navLinks={NAV_LINKS}
      hidePlaceholderBanner={true}
    >
      {loading && <div className="uim-info-banner">Loading data...</div>}
      {error && <div className="uim-info-banner" style={{background:'#f8d7da',borderColor:'#f5c6cb',color:'#721c24'}}>Unable to load data. The backend may be unavailable.</div>}
      <UimSection title={"Supervisor Review"}>
...
export default PersonModifyCountySupervisorReviewAfterPendingPage;
