...
export function PersonModifyProviderEnrollmentDetailsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_modifyProviderEnrollmentDetails"}
...
export default PersonModifyProviderEnrollmentDetailsPage;
