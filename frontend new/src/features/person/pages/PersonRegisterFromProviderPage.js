...
export function PersonRegisterFromProviderPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_registerFromProvider"}
      title={"Register From Provider"}
      navLinks={NAV_LINKS}
...
export default PersonRegisterFromProviderPage;
