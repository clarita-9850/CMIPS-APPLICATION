...
const NAV_LINKS = [
    { label: 'emp Wage Form Confirmation', route: '/person/emp-wage-form-confirmation' }
  ];

export function PersonProviderVerificationsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_providerVerifications"}
      title={"Print Verification Form:"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Details"}>
        <div className="uim-form-grid">
          ...
          <UimField label={"Form Type"} value={record && record['formType']} />
...
export default PersonProviderVerificationsPage;
