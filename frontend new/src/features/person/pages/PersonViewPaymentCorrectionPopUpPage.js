...
const NAV_LINKS = [
    { label: 'view Payment Correction List', route: '/person/view-payment-correction-list' },
...
export function PersonViewPaymentCorrectionPopUpPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_viewPaymentCorrectionPopUp"}
    ...
    >
      ...
      <div className="uim-action-bar">
        ...
        <button className="uim-btn uim-btn-primary" onClick={() => { personsApi.update(id, { status: 'approved' }).then(() => { alert('Approved successfully'); navigate(-1); }).catch(err => alert('Approve failed: ' + err.message)); }}>Approve</button>
...
export default PersonViewPaymentCorrectionPopUpPage;
