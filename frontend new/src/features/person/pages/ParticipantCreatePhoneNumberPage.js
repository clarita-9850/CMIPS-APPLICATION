...
export function ParticipantCreatePhoneNumberPage() {
  const navigate = useNavigate();
  const personsApi = getDomainApi('person');
  return (
    <UimPageLayout
      pageId={"Participant_createPhoneNumber"}
...
export default ParticipantCreatePhoneNumberPage;
