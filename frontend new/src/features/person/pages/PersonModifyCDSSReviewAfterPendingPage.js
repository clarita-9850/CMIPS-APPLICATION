...
export function PersonModifyCDSSReviewAfterPendingPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_modifyCDSSReviewAfterPending"}
      title={"Modify CDSS Review:"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"CDSS Supervisor Review"}>
        <div className="uim-form-grid">
          ...
          <UimField label={"CDSS Supervisor Review Outcome Entered Date"} value={record && record['cDSSSupervisorReviewOutcomeEnteredDate']} />
          <UimField label={"CDSS Review Letter Entered Date"} value={record && record['cDSSReviewLetterEnteredDate']} />
          <UimField label={"CDSS Review Comments"} value={record && record['cDSSReviewComments']} />
        </div>
      </UimSection>
...
export default PersonModifyCDSSReviewAfterPendingPage;
