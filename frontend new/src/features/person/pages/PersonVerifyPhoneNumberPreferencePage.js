...
const NAV_LINKS = [
    { label: 'resolve Timesheet Preferences', route: '/person/resolve-timesheet-preferences' }
  ];

export function PersonVerifyPhoneNumberPreferencePage() {
  const { id } = useParams();
  ...
  return (
    <UimPageLayout
      pageId={"Person_verifyPhoneNumberPreference"}
...
export default PersonVerifyPhoneNumberPreferencePage;
