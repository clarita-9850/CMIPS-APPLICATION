...
export function ParticipantModifyPhoneNumberFromViewPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Participant_modifyPhoneNumberFromView"}
      title={"Modify Phone Number From View"}
      navLinks={NAV_LINKS}
...
export default ParticipantModifyPhoneNumberFromViewPage;
