...
export function PersonModifyCountyDisputePage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_modifyCountyDispute"}
      title={"Modify County Dispute:"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"County Dispute Outcome"}>
        <div className="uim-form-grid">
      ...
      <UimSection title={"Dispute Supervisor"}>
        <div className="uim-form-grid">
          ...
          <UimField label={"County Dispute Outcome Reason"} value={record && record['countyDisputeOutcomeReason']} />
...
export default PersonModifyCountyDisputePage;
