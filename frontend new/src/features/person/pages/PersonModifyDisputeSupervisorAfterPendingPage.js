...
export function PersonModifyDisputeSupervisorAfterPendingPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_modifyDisputeSupervisorAfterPending"}
...
export default PersonModifyDisputeSupervisorAfterPendingPage;
