...
export function PersonRejectProviderEnrollmentPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_rejectProviderEnrollment"}
      title={"Reject Provider Enrollment:"}
      navLinks={NAV_LINKS}
...
export default PersonRejectProviderEnrollmentPage;
