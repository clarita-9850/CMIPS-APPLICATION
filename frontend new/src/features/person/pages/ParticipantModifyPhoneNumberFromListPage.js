...
export function ParticipantModifyPhoneNumberFromListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Participant_modifyPhoneNumberFromList"}
      title={"Modify Phone Number From List"}
      navLinks={NAV_LINKS}
...
export default ParticipantModifyPhoneNumberFromListPage;
