...
export function ParticipantModifyNoteFromViewPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Participant_modifyNoteFromView"}
      title={"Modify Note From View"}
      navLinks={NAV_LINKS}
...
export default ParticipantModifyNoteFromViewPage;
