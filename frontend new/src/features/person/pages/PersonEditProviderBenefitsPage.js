...
export function PersonEditProviderBenefitsPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_editProviderBenefits"}
      title={"-"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Provider Benefit Deduction"}>
...
export default PersonEditProviderBenefitsPage;
