...
export function PersonModifyStateSupervisorReviewAfterPendingPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_modifyStateSupervisorReviewAfterPending"}
...
export default PersonModifyStateSupervisorReviewAfterPendingPage;
