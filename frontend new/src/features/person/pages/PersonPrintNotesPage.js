...
export function PersonPrintNotesPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Person_printNotes"}
      title={"Print Person Notes Form:"}
      navLinks={NAV_LINKS}
    ...
    >
      ...
      <UimSection title={"Details"}>
        <div className="uim-form-grid">
          <UimField label={"Creation From Date"} value={record && record['creationFromDate']} />
          <UimField label={"Print"} value={record && record['print']} />
          <UimField label={"Creation To Date"} value={record && record['creationToDate']} />
        </div>
      </UimSection>
...
export default PersonPrintNotesPage;
