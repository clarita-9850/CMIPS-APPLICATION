...
const NAV_LINKS = [
    { label: 'view Email Address', route: '/person/view-email-address' }
  ];

export function ParticipantModifyEmailAddressFromViewPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Participant_modifyEmailAddressFromView"}
...
export default ParticipantModifyEmailAddressFromViewPage;
