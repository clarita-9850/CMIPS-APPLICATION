...
export function ParticipantModifyNoteFromListPage() {
  ...
  return (
    <UimPageLayout
      pageId={"Participant_modifyNoteFromList"}
      title={"Modify Note From List"}
      navLinks={NAV_LINKS}
...
export default ParticipantModifyNoteFromListPage;
