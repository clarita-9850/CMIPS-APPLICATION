...
import { ModifyEnrollmentPage } from './pages/ModifyEnrollmentPage';
...
// UIM-converted pages
import { ProviderEnrollmentHistoryPage } from './pages/uim/ProviderEnrollmentHistoryPage';
...
// Provider / Organization (from UIM stubs)
import { OrganizationResolveUserPage } from './features/provider/pages/OrganizationResolveUserPage';
import { OrganizationUserHomePopupPage } from './features/provider/pages/OrganizationUserHomePopupPage';
import { OrganizationChangeUserPage } from './features/provider/pages/OrganizationChangeUserPage';
import { OrganizationTaskRedirectionPage } from './features/provider/pages/OrganizationTaskRedirectionPage';
import { OrganizationUserHomePage } from './features/provider/pages/OrganizationUserHomePage';
import { OrganizationResourceHomePage } from './features/provider/pages/OrganizationResourceHomePage';
import { OrganizationModifyPrinterForUserPage } from './features/provider/pages/OrganizationModifyPrinterForUserPage';

// Missing misc UIM stubs
import { IHSSCaseHomePage } from './features/misc/pages/IHSSCaseHomePage';
import { InboxListUnreservedWorkQueueTasksPage } from './features/misc/pages/InboxListUnreservedWorkQueueTasksPage';
import { IntegratedCaseResolveHomePage } from './features/misc/pages/IntegratedCaseResolveHomePage';
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            <Route path="/providers/:id/modify-enrollment" element={<ModifyEnrollmentPage />} />
            <Route path="/providers/:id/enrollment-history" element={<ProviderEnrollmentHistoryPage />} />
            ...
            {/* Provider / Organization UIM routes */}
            <Route path="/provider/resolve-user" element={<OrganizationResolveUserPage />} />
            <Route path="/provider/user-home-popup" element={<OrganizationUserHomePopupPage />} />
            <Route path="/provider/change-user" element={<OrganizationChangeUserPage />} />
            <Route path="/provider/task-redirection" element={<OrganizationTaskRedirectionPage />} />
            <Route path="/provider/user-home" element={<OrganizationUserHomePage />} />
            <Route path="/provider/resource-home" element={<OrganizationResourceHomePage />} />
            <Route path="/provider/modify-printer-for-user" element={<OrganizationModifyPrinterForUserPage />} />

            {/* Missing misc UIM routes */}
            <Route path="/case/ihss-case-home" element={<IHSSCaseHomePage />} />
            <Route path="/misc/list-unreserved-work-queue-tasks" element={<InboxListUnreservedWorkQueueTasksPage />} />
            <Route path="/misc/resolve-home" element={<IntegratedCaseResolveHomePage />} />
          ...
          {/* Default redirect - TESTING MODE: Always go to workspace */}
          <Route
            path="/"
