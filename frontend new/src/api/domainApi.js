...
const countyApi = {
  list:   (params = {}) => http.get(`/county-contractors/rates${qs(params)}`).then(r => r.data),
  get:    (id) => http.get(`/county-contractors/rates/${id}`).then(r => r.data),
  search: (params) => http.get(`/county-contractors/rates${qs(params)}`).then(r => r.data),
  create: (data) => http.post('/county-contractors/rates', data).then(r => r.data),
  update: (id, data) => http.put(`/county-contractors/rates/${id}`, data).then(r => r.data),
};
