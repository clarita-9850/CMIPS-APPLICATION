...
/**
 * TESTING MODE: Permission checks bypassed - all routes accessible
 */
export const PermissionRoute = ({ children }) => {
  // TESTING MODE: Bypass all permission checks
  // TODO: Remove this bypass for production
  return <>{children}</>;

  /* ORIGINAL PERMISSION CODE - Re-enable for production:
