...
public class ProviderCoriEntity {
    ...
    @Column(name = "cori_date")
    private LocalDate coriDate;
    ...
    private ProviderCoriEntity(Builder builder) {
        ...
        this.coriDate = builder.coriDate;
    ...
    public LocalDate getCoriDate() { return coriDate; }
    public void setCoriDate(LocalDate coriDate) { this.coriDate = coriDate; }
    ...
    public static class Builder {
        ...
        public Builder coriDate(LocalDate coriDate) { this.coriDate = coriDate; return this; }
