...
public class AuthorizationAspect {
    ...
    @Value("${cmips.security.disable:false}")
    ...
    public Object checkPermission(ProceedingJoinPoint joinPoint, RequirePermission requirePermission) throws Throwable {
        ...
        // TESTING MODE: Skip authorization when security is disabled
        if (disableSecurity) {
            logger.info("Security disabled - bypassing authorization check for method: {}", joinPoint.getSignature().getName());
