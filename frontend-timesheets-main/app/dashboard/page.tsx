  ...
  useEffect(() => {
    ...
    const loadCounties = async () => {
      try {
        ...
        console.log('🔍 Dashboard: Loading counties for role:', userRole);
        ...
        if (user.role?.toUpperCase() === 'DISTRICT_WORKER' && normalizedOptions.length === 1) {
          setCountyId(normalizedOptions[0].value);
        } else if (user.countyId) {
          const normalizedUserCounty = user.countyId.toLowerCase();
      ...
      <div className={styles.page}>
        ...
        <section className={styles.controlsPanel}>
          <div className={styles.controlsGrid}>
            ...
            <div className={styles.controlGroup}>
              <label className={styles.controlLabel}>County</label>
              <select
                value={countyId}
